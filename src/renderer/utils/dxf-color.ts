 ...
 */
export function aciToHex(value: number | null | undefined): string | null {
 ...
 */
export function normalizeHexColor(value: string | unknown): string | null {
 ...
 */
export function normalizeAci(value: unknown): number | null {
 ...
 */
export function trueColorToHex(value: number | unknown): string | null {
